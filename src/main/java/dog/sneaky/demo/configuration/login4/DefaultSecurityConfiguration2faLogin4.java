...
public class DefaultSecurityConfiguration2faLogin4 extends AbstractSecurityConfiguration {
    @Resource
...
////                .jwt();
        ...
        Login4MfaAuthenticationHandler mfaAuthenticationHandler = new Login4MfaAuthenticationHandler("/second-factor4.html");
...
//                "/actuator/**",
                        ...
                        .requestMatchers("/second-factor4.html", "/second-factor4").access(mfaAuthorizationManager)
